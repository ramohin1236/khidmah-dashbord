    ...
    return (
        ...
        >
            <div className={`bg-white rounded-2xl p-8 w-full max-w-md relative transform transition-all duration-300 ${isAnimating ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
                ...
                <h2 className="text-3xl font-bold text-[#1E293B] mb-2 text-center">Add Brand</h2>
                <p className="text-base text-[#64748B] mb-8 text-center">Create a new product brand.</p>

                <div className="space-y-6">
                    <div>
                        <label className="block text-base font-semibold text-[#1E293B] mb-2">Brand Name</label>
                        <input
                            type="text"
                            value={name}
